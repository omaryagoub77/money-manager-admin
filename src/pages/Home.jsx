...
const Home = () => {
  const routes = [
    ...
    { name: 'Deposits', path: '/deposits', description: 'Manage customer deposits and transactions' },
    { name: 'Cashout', path: '/cashout', description: 'Manage customer cashout and transactions' },
